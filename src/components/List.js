    ...
    <div>
      ...
      <div >
        {items.length > 0 ?
          ...
          :
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, overflowY: 'scroll', width: "45vw", height: "30vh", borderColor: '#F2F2F2', borderWidth: 5, borderStyle: "solid" }}>
            <h2 style={{opacity: 0.2}}>Drop here done tasks</h2>
          </div>
        }
      </div>
    </div>
